...
export default function LiquidEther({
  ...
  dt = 0.014,
  BFECC = true,
  resolution = typeof window !== 'undefined' && window.innerWidth < 768 ? 0.25 : 0.45,
  isBounce = false,
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(args?: AdvectionUpdateArgs) {
    ...
    interface ExternalForceUpdateArgs {
      cursor_size?: number;
      mouse_force?: number;
      cellScale?: THREE.Vector2;
    }
      ...
      init() {
        ...
        const mouseM = new THREE.RawShaderMaterial({
          ...
          uniforms: {
            ...
            scale: { value: new THREE.Vector2(simProps.cursor_size || 100, simProps.cursor_size || 100) }
          }
        });
        this.mouse = new THREE.Mesh(mouseG, mouseM);
        this.scene!.add(this.mouse);
      }
      update(args?: ExternalForceUpdateArgs) {
        const props = args || {};
    ...
    class Viscous extends ShaderPass {
      ...
      update(args?: ViscousUpdateArgs): THREE.WebGLRenderTarget | undefined {
    ...
    interface DivergenceUpdateArgs {
    ...
    class Divergence extends ShaderPass {
      ...
      update(args?: DivergenceUpdateArgs) {
        const { vel } = args || {};
    ...
    class Poisson extends ShaderPass {
      ...
      update(args?: PoissonUpdateArgs): THREE.WebGLRenderTarget | undefined {
    ...
    class Pressure extends ShaderPass {
      ...
      update(args?: PressureUpdateArgs) {
    ...
    const io = new IntersectionObserver(
      ...
      { threshold: [0, 0.01, 0.1], rootMargin: '0px' }
    );
  ...
  return (
    <div
      ...
      style={{ ...style, pointerEvents: 'auto' }} // 🔥 pointerEvents habilitado
    />
  );
}
